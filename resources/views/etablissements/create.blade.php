@extends('layouts.app')
@section('content')
<form style="width: 22rem;" method="POST" action="{{route('etablissements.store')}}" class="mt-5">
    <!-- Name input -->
    @csrf
    <div class="form-outline mb-4">
        <label class="form-label" for="form5Example1">Etablissement</label>
      <input type="text" name="etablissement" value='{{old('etablissement')}}' id="form5Example1" class="form-control" />
      @error('etablissement')
    ...
    <div  class="form-outline mb-4">
      ...
      <input type="text" name="code" value='{{old('code')}}' id="form5Example1" class="form-control" />
      @error('code')
      <div class="alert alert-danger m-3">
        {{ $message }}
    </div>
    ...
    <div  class="form-outline mb-4">
      ...
      <input type="text" name="adresse" value='{{old('adresse')}}' id="form5Example1" class="form-control" />
      @error('adresse')
      <div class="alert alert-danger m-3">
        {{ $message }}
    </div>
    ...
    <div  class="form-outline mb-4">
      ...
      <input type="text" name="fax" value='{{old('fax')}}' id="form5Example1" class="form-control" />
      @error('fax')
      <div class="alert alert-danger m-3">
        {{ $message }}
    </div>
